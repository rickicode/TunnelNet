...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ __('bap.direction') }}">
    ...
    <body class="antialiased" x-data="{ darkTheme: $persist(true) }" :class="darkTheme ? '' : 'theme-dark'">
    <div class="wrapper">
        <header class="navbar navbar-expand-md navbar-dark d-print-none">
            <div class="{{ config('bap.container-app', 'container') }}">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a style="text-decoration-line: none;" href="{{ route('home') }}">
                        {{-- <img src="{{ asset('images/logo-dark.svg') }}" width="110" height="32" alt="{{ config('app.name', 'Laravel') }}" class="navbar-brand-image"> --}}
                        <h1 class="m-0 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white no-underline">{{ config('app.name', 'Laravel') }}</h1>
